            ...
            while ((line = bufferRead.readLine()) != null) {
                if (line.startsWith("Date:")) {
                    ...
                    if (line.contains(".")) {
                        ...
                        String repsPerSet = exerciseParts[REPS_PER_SET_INDEX_1] + SPACE + exerciseParts[REPS_PER_SET_INDEX_2]
                                + SPACE + exerciseParts[REPS_PER_SET_INDEX_3] + SPACE + exerciseParts[REPS_PER_SET_INDEX_4];
